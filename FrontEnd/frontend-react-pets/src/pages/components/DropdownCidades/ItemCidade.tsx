...
export default function ItemCidade() {
    ...
    return (
        <div className="row">
            {cidadesBrasil.map((obg: CidadesBrasil) => (
                <div className="col-12 col-sm-4 margemVertical">
                    <div className="card text-bg-info margemLateral">
                        <h4 className="card-header">
                            Nome da cidade: {obg.shelterCity}
                        </h4>
                        <div className="card-body">
                            <div className="centro">
                                ...
                                >
                                    Latitude: {obg.shelterLat}
                                </div>
                                <div className="card-text btn btn-warning">
                                    Longitude: {obg.shelterLng}
                                </div>
                            </div>
                        </div>
                    </div>
